# brz_toast_config_revenue_centers
...
Purpose: Pull revenue center config into Bronze.
Source Objects: Toast API /config/v2/revenueCenters
Status: Documented
Target Object: brz_toast_config_revenue_centers
...
let
    ...
    sourceSystem = "toast",
    sourceEndpoint = "/config/v2/revenueCenters",
    recordSource = "config_revenue_centers_api",
    ...
    response =
        Json.Document(
            Web.Contents(
                apiHost,
                [
                    RelativePath = "config/v2/revenueCenters",
                    Headers = [
