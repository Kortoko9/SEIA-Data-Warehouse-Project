# brz_toast_menus_metadata

Artifact Type: Power Query M
Build Method: Query
Dependencies: Toast auth; restaurant GUID; menus:read scope
Grain: One row per menu metadata payload
Last Updated: April 27, 2026
Layer: Bronze
Notes: Used to determine whether full menu reload is needed.
Primary / Merge Key: payload_hash
Purpose: Pull menu metadata/staleness payload into Bronze.
Source Objects: Toast API /menus/v2/metadata
Status: Documented
Target Object: brz_toast_menus_metadata
...
let
    ...
    sourceSystem = "toast",
    sourceEndpoint = "/menus/v2/metadata",
    recordSource = "menus_metadata_api",
    ...
    response =
        Json.Document(
            Web.Contents(
                apiHost,
                [
                    RelativePath = "menus/v2/metadata",
                    Headers = [
