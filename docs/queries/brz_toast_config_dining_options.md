# brz_toast_config_dining_options
...
Purpose: Pull dining option config into Bronze.
Source Objects: Toast API /config/v2/diningOptions
Status: Documented
Target Object: brz_toast_config_dining_options
...
let
    ...
    sourceSystem = "toast",
    sourceEndpoint = "/config/v2/diningOptions",
    recordSource = "config_dining_options_api",
    ...
    response =
        Json.Document(
            Web.Contents(
                apiHost,
                [
                    RelativePath = "config/v2/diningOptions",
                    Headers = [
